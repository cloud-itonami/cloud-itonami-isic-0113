(ns vegops.phase
  "Phase gate for the vegetable/root-crop-growing operations coordinator
  rollout (0->3 maturity). Mirrors `cerealops.phase` (cloud-itonami-isic-0111)
  ...
  Phase 1: supervised operation -- always-escalate ops
    (`vegops.governor/always-escalate-ops`) escalate even when clean;
  ...
  (:require [vegops.governor :as governor]))
