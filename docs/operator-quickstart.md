# Operator Quickstart — Vegetable and Root-Crop Growing Operations Coordination

Shortest path from clone to a verified local dry-run for **ISIC 0113** (`cloud-itonami-isic-0113`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-0113.git
cd cloud-itonami-isic-0113
```
...
- Likely source path: `vegops.governor.cljc`
